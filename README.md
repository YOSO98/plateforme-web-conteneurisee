...
Déployer une application web conteneurisée dans un contexte Cloud à l'aide de Docker et Docker Compose.
Ce projet simule un déploiement applicatif réel en environnement serveur, avec des bonnes pratiques DevOps.
...
La documentation détaillée du projet est disponible dans le dossier `docs/` :
...
Les logs applicatifs sont accessibles via Docker et Docker Compose.

---

## 🎓 Contexte académique

Projet réalisé dans le cadre d'une montée en compétences Cloud/DevOps.
